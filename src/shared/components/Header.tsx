    ...
    <TooltipProvider delayDuration={300}>
      <header className="h-11 border-b border-border bg-card/70 backdrop-blur px-3 flex items-center justify-between select-none">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Format Switcher: JSON / SQLite / CSV */}
            ...
            <TooltipTrigger asChild>
              ...
              >
                ...
                <span className="hidden sm:inline">
                  Sample {activeFormat === 'sqlite' ? 'DB' : activeFormat === 'csv' ? 'CSV' : 'JSON'}
                </span>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
              Load sample {activeFormat === 'sqlite' ? 'SQLite database' : activeFormat === 'csv' ? 'CSV dataset' : 'JSON dataset'}
            </TooltipContent>
          </Tooltip>
